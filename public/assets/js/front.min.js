...
function scroll(){$(window).scrollTop()>50?$("body").addClass("reduced"):$("body").removeClass("reduced"),$(window).scroll(function(){$(this).scrollTop()>50?$("body").addClass("reduced"):$("body").removeClass("reduced")})}$(document).ready(function(){scroll()});