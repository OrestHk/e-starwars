...
function init(){scroll(),menu(),fixFooter(),$(window).resize(function(){menuOverflow(),fixFooter()})}function fixFooter(){var e=$(".main-container").height(),n=$(window).height();n>e?$("footer").addClass("fixed"):$("footer").removeClass("fixed")}function menuOverflow(){var e=$(".main-menu").height();$(".main-menu .main").each(function(){e-=$(this).outerHeight(!0)}),e-=$(".main-menu .tags").outerHeight(!0)-$(".main-menu .tags").outerHeight(),$(".main-menu .tags").css("max-height",e)}function menu(){$(".menu, .overlay").click(function(){$(".menu").toggleClass("open"),$(".overlay").fadeToggle(300),$(".main-menu").toggleClass("open"),$("body").toggleClass("hidden")}),menuOverflow()}function scroll(){$(window).scrollTop()>50?$("body").addClass("reduced"):$("body").removeClass("reduced"),$(window).scroll(function(){$(this).scrollTop()>50?$("body").addClass("reduced"):$("body").removeClass("reduced")})}function setCookie(e,n,o){var i=new Date;i.setTime(i.getTime()+24*o*60*60*1e3);var t="expires="+i.toUTCString();document.cookie=cname+"="+cvalue+"; "+t}function getCookie(e){var e=e+"=",n=document.cookie.split(";"),o=0,i=n.length;for(o;i>o;o++){for(var t=n[o];" "==t.charAt(0);)t=t.substring(1);if(0==t.indexOf(e))return t.substring(e.length,t.length)}return""}$(document).ready(function(){init()});