...
function menuOverflow(){var e=$(".main-menu").height();$(".main-menu .main").each(function(){e-=$(this).outerHeight(!0)}),e-=$(".main-menu .tags").outerHeight(!0)-$(".main-menu .tags").outerHeight(),$(".main-menu .tags").css("max-height",e)}function menu(){$(".menu").click(function(){$(this).toggleClass("open"),$(".overlay").fadeToggle(300),$(".main-menu").toggleClass("open"),$("body").toggleClass("hidden")}),menuOverflow()}function scroll(){$(window).scrollTop()>50?$("body").addClass("reduced"):$("body").removeClass("reduced"),$(window).scroll(function(){$(this).scrollTop()>50?$("body").addClass("reduced"):$("body").removeClass("reduced")})}$(document).ready(function(){scroll(),menu()}),$(window).resize(function(){menuOverflow()});