...
"use strict";var Cart={totalPrice:0,product:[],order:{},addOderItem:function(e,o){this.order[e]=o,this.orderToCookie(),$("#successAddInCart").fadeIn().delay(2500).fadeOut()},orderToCookie:function(){Cookies.set("SwC",this.order),console.log(Cookies.get())},orderToObj:function(){this.order=JSON.parse(Cookies.get("SwC")),console.log(this.order)},orderProced:function(){var e=$('meta[name="csrf-token"]').attr("content"),o=$("#CustomerName").val(),t=$("#CustomerMail").val();console.log(o,t),$.ajax({url:"/validationOrder/",type:"POST",data:{_token:e,order:this.order,name:o,email:t,total:this.totalPrice},dataType:"JSON",complete:function(e){1==e&&($("#successOrder").fadeIn().delay(5e3).fadeOut(),window.location.reload())},error:function(e){console.log(e)}})}};$(document).ready(function(){var e="products"==location.pathname.split("/")[1]?!0:!1;e&&Cart.orderToObj()}),$("#orderValidation").submit(function(e){e.preventDefault(),Cart.orderProced()}),$('input[name="order"]').on("click",function(e){e.preventDefault(),Cart.addOderItem($('input[name="product_id"]').val(),$("#quantity :selected").text())});
function fixFooter(){var e=$(".main-container").height(),o=$(window).height();o>e?$("footer").addClass("fixed"):$("footer").removeClass("fixed")}function menuOverflow(){var e=$(".main-menu").height();$(".main-menu .main").each(function(){e-=$(this).outerHeight(!0)}),e-=$(".main-menu .tags").outerHeight(!0)-$(".main-menu .tags").outerHeight(),$(".main-menu .tags").css("max-height",e)}function menu(){$(".menu, .overlay").click(function(){$(".menu").toggleClass("open"),$(".overlay").fadeToggle(300),$(".main-menu").toggleClass("open"),$("body").toggleClass("hidden")}),menuOverflow()}function scroll(){$(window).scrollTop()>50?$("body").addClass("reduced"):$("body").removeClass("reduced"),$(window).scroll(function(){$(this).scrollTop()>50?$("body").addClass("reduced"):$("body").removeClass("reduced")})}$(document).ready(function(){scroll(),menu(),fixFooter()}),$(window).resize(function(){menuOverflow(),fixFooter()});
=======
...
>>>>>>> bff82e428513c06bec6161deabaf7b05db31f0eb
