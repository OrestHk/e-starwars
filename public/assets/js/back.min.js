...
$(document).ready(function(){$(".alert.alert-info").delay(5e3).fadeOut("slow"),$(".form-group .btn-delete").click(function(){var t=$(".delete-conf form"),e=t.attr("data-url")+"/"+$(this).attr("data-id");t.attr("action",e),$(".delete-conf #id").val($(this).attr("pid")),$(".delete-conf").fadeIn(300)}),$(".delete-conf .aboart").click(function(t){t.preventDefault(),$(".delete-conf").fadeOut(300)})});